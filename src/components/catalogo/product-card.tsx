        ...
        >
            ...
            >
                ...
                <div className="p-4 space-y-3">
                    <h3 className="font-semibold line-clamp-2 group-hover:text-primary transition-colors">{product.titulo}</h3>

                    <p className="text-sm text-muted-foreground line-clamp-2">{product.resumen}</p>
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-border">
                        <span className="text-lg font-bold text-primary">${Number.parseFloat(product.precio).toFixed(2)}</span>
